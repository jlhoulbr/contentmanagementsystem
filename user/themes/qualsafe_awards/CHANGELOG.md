...
1. [](#bugfix)
    * Allow to add a `external` class to site.yaml links to work on modular pages [#95](https://github.com/getgrav/grav-theme-qualsafe_awards/pull/95)
...
1. [](#bugfix)
    * Removed unreachable condition [#85](https://github.com/getgrav/grav-theme-qualsafe_awards/pull/85)
...
1. [](#new)
    * Added microformats2 support [#64](https://github.com/getgrav/grav-theme-qualsafe_awards/pull/64)
1. [](#improved)
...
1. [](#new)
    ...
    * Updated `README.md` with some instructions on how to use some qualsafe_awards features
1. [](#improved)
    * Removed `cache.html.twig` file that was used only for testing
    * Removed unused `color` option in `qualsafe_awards.yaml`
...
1. [](#improved)
    ...
    * Removed featherlight from qualsafe_awards
1. [](#bugfix)
