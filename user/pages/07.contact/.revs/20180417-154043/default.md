...
<form id="test" class="test" onsubmit="return formHandler('test')">
<div id="panel0" class="open-editPanel ui-sortable-handle demo"><label class="label-title">test</label><select class="dropdown" name="test">
