...
<form id="ContactUs" class="Contact Us" onsubmit="return formHandler('ContactUs')">
<div id="panel0" class="open-editPanel ui-sortable-handle demo"><label class="label-title">Nein</label><input class="text-field" name="Nein" type="text" /></div>
<div id="panel1" class="open-editPanel demo"><label class="label-title">Age</label><input class="number-field" name="Age" type="number" /></div>
