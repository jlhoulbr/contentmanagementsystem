...
$formHTML = str_replace('<span class="remove-formPanel" style="display: block;"><img class="remove-img" src="/grav-admin/images/custom/delete.png"></span>',"",$formHTML);
$formHTML = str_replace('style="outline: rgb(212, 212, 212) solid 1px;" ',"",$formHTML);
$formHTML = str_replace('<input class="empty ui-sortable-handle" style="">',"",$formHTML);
$formHTML = str_replace('<span class="remove-formPanel"><img class="remove-img" src="/grav-admin/images/custom/delete.png"></span>',"",$formHTML);
...
$formHTML = str_replace('<img class="sortable-img" src="/grav-admin/images/custom/sortable.png">',"",$formHTML);
