...
/* revisions.html.twig */
class __TwigTemplate_527cdf5814c3396841eed86039f5ca573ce0adab1ac84acdbaa86b5ac4a83f70 extends Twig_Template
{
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["page"]) {
                ...
                if (($this->getAttribute($context["page"], "revisions", array()) > 0)) {
                    ...
                    echo ") (";
                    echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Common\Twig\TwigExtension')->nicetimeFunc($this->getAttribute($context["page"], "lastRevision", array()), true), "html", null, true);
                    echo ")</div>
          ";
                } else {
                    // line 33
      ...
      <div class=\"revision-list\">
        ";
          ...
          ";
                    ...
                    echo twig_escape_filter($this->env, $this->getAttribute($context["revision"], "name", array()), "html", null, true);
                    echo "</a> (";
                    echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Common\Twig\TwigExtension')->nicetimeFunc($this->getAttribute($context["revision"], "createdAt", array()), true), "html", null, true);
                    echo ")</div>
          ";
                }
                // line 48
